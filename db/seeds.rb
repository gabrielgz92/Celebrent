...
[Booking, Wishlist, CelebrityTag, Tag, Celebrity, User].each(&:destroy_all)
puts "----------------------"
...
puts "Seeded #{Celebrity.count} celebrities(s)."
...
puts "Seeded #{Booking.count} booking(s)."
